...
class RequestHandler(object):
    ...
    async def __call__(self, request):
        ...
        try:
            ...
            return await build_response(self._app, request, result)
        except APIError as ex:
            return await build_response(self._app, request, dict(error=ex.error, data=ex.data, message=ex.message))
...
async def build_response(app, request, result):
    ...
    if isinstance(result, dict):
        ...
        from app.handlers.common import get_categories
